<?php
/**
 * ManagementDB - Classe para gerenciamento da base de dados
 *
 * @package TutsupMVC
 * @since 0.1
 */
class ManagementDB
{
	...
	public $host      = 'localhost', // Host da base de dados 
	       $db_name   = 'matizamu_blog',    // Nome do banco de dados
	       $password  = 'root123456',          // Senha do usuário da base de dados
	       $user      = 'matizamu_bloadm',      // Usuário da base de dados
